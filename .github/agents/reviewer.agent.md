...
argument-hint: Request, diff or files to review, and verification evidence
user-invocable: true
---
...
1. Read the request, plan, changed files, relevant memory, and relevant skills.
...
- Treat missing evidence as risk when the change affects user-facing or shared behavior.
